...
import { Wallet, Twitter, Send, Discord } from 'lucide-react';
  ...
  return (
    <header className="sticky top-0 flex h-20 items-center gap-4 px-4 md:px-6 z-50">
      ...
      <nav className="hidden flex-col gap-6 text-lg font-medium md:flex md:flex-row md:items-center md:gap-5 md:text-sm lg:gap-6">
        <Link href="#" className="text-muted-foreground transition-colors hover:text-foreground">Supa Labs</Link>
        <Link href="#" className="text-muted-foreground transition-colors hover:text-foreground">Airdrop</Link>
        <Link href="#" className="text-muted-foreground transition-colors hover:text-foreground">Scan</Link>
      </nav>
      ...
      <div className="flex items-center gap-4">
        ...
        <Send className="h-5 w-5 text-muted-foreground hover:text-foreground cursor-pointer" />
        <Button variant="secondary" size="sm" className='font-bold rounded-lg'>
